...
final class CapacitorPlaceAutocompleteResultViewController: UIViewController {
    ...
    static func instantiate(with result: PlaceAutocomplete.Result) -> CapacitorPlaceAutocompleteResultViewController {
        ...
        let viewController = storyboard.instantiateViewController(
            withIdentifier: "CapacitorPlaceAutocompleteResultViewController"
        ) as? CapacitorPlaceAutocompleteResultViewController
...
extension CapacitorPlaceAutocompleteResultViewController: UITableViewDataSource {
